      ...
      <div className="ProgrammerEx" id={this.props.myID}>
        ...
        >
          <div className="programmerSkills">
            <SkillsDesc
              descTitle="Learning"
              desc="JavaScript, jQuery, Git, GitHub, REST APIs, Java, Android Studio, React, MySQL, PHP, Python, Swift, Xcode"
            />
            <SkillsDesc descTitle="Intermediate" desc="HTML, CSS, Sass, C++" />
          </div>
